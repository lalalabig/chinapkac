    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "package_name",
                    models.CharField(max_length=200, verbose_name="包名称"),
                ),
                (
                    "zip_file",
                    models.FileField(
                ...
                (
                    "total_reports",
                    models.PositiveIntegerField(default=0, verbose_name="报告总数"),
                ),
                (
                    "total_size",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "viewed_at",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="查看时间"
                    ),
                ),
                (
                    "approved_at",
            ...
            options={
                ...
                "unique_together": {
                    ("uploader", "report_type", "report_period", "task_area")
                },
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="reports.bulkdownloadpackage",
                    ),
                ),
                (
                    "report",
